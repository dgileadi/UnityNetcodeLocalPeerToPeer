...
namespace Unity.Netcode
{
    ...
    public class MultiplexTransportAdapter : NetworkTransport
    {
        ...
        public enum ConnectionIdSpreadMethod
        {
            ...
            /// Ensure that ALL transports don't use the last bits in their produced clientId.
            ...
            /// Ensure that ALL transports don't use the first few bits in the produced clientId.
            /// </summary>
            ReplaceFirstBits,
            ...
            /// Ensure that ALL transports don't use the first bits in their produced clientId.
            /// </summary>
            MakeRoomFirstBits,
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        public override void Initialize(NetworkManager networkManager = null)
        {
            for (int i = 0; i < Transports.Length; i++)
            {
                ...
                {
                    Transports[i].Initialize(networkManager);
                }
            }
        }
        ...
        public override NetworkEvent PollEvent(out ulong clientId, out ArraySegment<byte> payload, out float receiveTime)
        {
            ...
            for (byte i = m_LastProcessedTransportIndex; i < Transports.Length; i++)
            {
                ...
                if (Transports[i].IsSupported)
                {
                    var networkEvent = Transports[i].PollEvent(out ulong connectionId, out payload, out receiveTime);
        ...
        public override void Send(ulong clientId, ArraySegment<byte> payload, NetworkDelivery networkDelivery)
        {
            ...
            Transports[transportId].Send(connectionId, payload, networkDelivery);
        }
        ...
        public override bool StartClient()
        {
            ...
            for (int i = 0; i < Transports.Length; i++)
            {
                if (Transports[i].IsSupported)
                {
                    started |= Transports[i].StartClient();
                }
            }
            return started;
        }
        ...
        public override bool StartServer()
        {
            ...
            for (int i = 0; i < Transports.Length; i++)
            {
                if (Transports[i].IsSupported)
                {
                    started |= Transports[i].StartServer();
                }
            }
            return started;
        }
